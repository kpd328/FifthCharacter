...
namespace WotC.FifthEd.SRD.Features.PlayerClass.Monk {
    public abstract class AFeatureMonk : IFeature {
        public abstract string Name { get; }
        public virtual string ID => string.Format("SRD.Feature.Class.Monk.{0}", Regex.Replace(Regex.Replace(Name, @"[^0-9a-zA-Z:]+", ""), @"[:]", "."));
        public virtual string Source => "Class Monk";
