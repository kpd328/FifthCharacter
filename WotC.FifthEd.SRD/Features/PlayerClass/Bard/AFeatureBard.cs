...
namespace WotC.FifthEd.SRD.Features.PlayerClass.Bard {
    public abstract class AFeatureBard : IFeature {
        public abstract string Name { get; }
        public virtual string ID => string.Format("SRD.Feature.Class.Barbarian.{0}", Regex.Replace(Name, @"[^0-9a-zA-Z:.]+", "").Replace(':', '.'));
        public virtual string Source => "Class Bard";
