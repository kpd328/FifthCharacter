...
namespace WotC.FifthEd.SRD.Features.Race.HalfOrc {
    public class FHalfOrcDarkvision : IFeature {
        public string Name => "Darkvision";
        public string ID => "SRD.Feature.Race.HalfOrc.Darkvision";
        public string Source => "Race Half-Orc";
        public string Text => RacialFeatures.Darkvision_Half_Orc;
        ...
        public IFeature GetInstance() => new FHalfOrcDarkvision();
