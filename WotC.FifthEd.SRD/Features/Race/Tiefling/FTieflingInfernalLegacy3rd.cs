...
namespace WotC.FifthEd.SRD.Features.Race.Tiefling {
    public class FTieflingInfernalLegacy3rd : IFeature {
        public string Name => "Infernal Legacy";
        public string ID => "SRD.Feature.Race.Tiefling.InfernalLegacy.3rd";
        public string Source => "Race Tiefling";
        public string Text => RacialFeatures.Infernal_Legacy_3rd;
        ...
        public IFeature GetInstance() => new FTieflingInfernalLegacy3rd();
