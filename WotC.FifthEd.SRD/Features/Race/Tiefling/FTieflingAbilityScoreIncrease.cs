...
namespace WotC.FifthEd.SRD.Features.Race.Tiefling {
    public class FTieflingAbilityScoreIncrease : IFeature {
        public string Name => "Ability Score Increase";
        public string ID => "SRD.Feature.Race.Tiefling.Ability Score Increase";
        public string Source => "Race Tiefling";
        public string Text => RacialFeatures.Ability_Score_Increase_Tiefling;
        ...
        public IFeature GetInstance() => new FTieflingAbilityScoreIncrease();

        public void ModAbility() {
            AbilityManager.IntelligenceScore += 2;
