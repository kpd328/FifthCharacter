...
namespace WotC.FifthEd.SRD.Features.Race.Halfling {
    public class FHalflingBrave : IFeature {
        public string Name => "Brave";
        public string ID => "SRD.Feature.Race.Halfling.Brave";
        public string Source => "Race Halfling";
        public string Text => RacialFeatures.Brave;
        ...
        public IFeature GetInstance() => new FHalflingBrave();
