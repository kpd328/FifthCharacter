...
namespace WotC.FifthEd.SRD.Features.Race.Halfling {
    public class FHalflingAbilityScoreIncrease : IFeature {
        public string Name => "Ability Score Increase";
        public string ID => "SRD.Feature.Race.Halfling.AbilityScoreIncrease";
        public string Source => "Race Halfling";
        public string Text => RacialFeatures.Ability_Score_Increase_Halfling;
        ...
        public IFeature GetInstance() => new FHalflingAbilityScoreIncrease();
