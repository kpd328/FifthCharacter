...
namespace WotC.FifthEd.SRD.Features.Race.HalfElf {
    class FHalfElfAbilityScoreIncrease : IFeature {
        public string Name => "Ability Score Increase";
        public string ID => "SRD.Feature.Race.HalfElf.AbilityScoreIncrease";
        public string Source => "Race Half-Elf";
        public string Text => RacialFeatures.Ability_Score_Increase_Half_Elf;
        ...
        public IFeature GetInstance() => new FHalfElfAbilityScoreIncrease();

        public void ModAbility() {
            AbilityManager.CharismaScore += 2;
            //TODO: prompt for two other scores to increase by 1
        }
    }
}
