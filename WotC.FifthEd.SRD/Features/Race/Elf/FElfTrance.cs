...
namespace WotC.FifthEd.SRD.Features.Race.Elf {
    public class FElfTrance : IFeature {
        public string Name => "Trance";
        public string ID => "SRD.Feature.Race.Elf.Trance";
        public string Source => "Race Elf";
        public string Text => RacialFeatures.Trance;
        ...
        public IFeature GetInstance() => new FElfTrance();
